...
#define TYPES                                                                  \
  bool, int32_t, double, std::shared_ptr<test>, const std::shared_ptr<test> &, \
...
public:
  ...
  test(int32_t i, TYPES) : i(i) { printf("ctor!\n"); }
  ...
  double fd(TYPES) const {
    i++;
    return d;
  }
  const std::shared_ptr<test> &fspt(TYPES) {
    i++;
    return spt;
  }
  const std::string &fs(TYPES) {
    i++;
    return s;
  }
  void f(TYPES) { i++; }
...
void qjs_glue(qjs::Context::Module &m) {
  m.function<&::f>("f"); // (bool, ::int32_t, double, ::std::shared_ptr<test>,
                         // ::std::shared_ptr<test> const &, ::std::string,
                         // ::std::string const &)
  ...
  m.class_<::test>("test")
      //.base<::base_test>()
      .constructor<::int32_t, bool, ::int32_t, double, ::qjs::shared_ptr<test>,
                   ::qjs::shared_ptr<test> const &, ::std::string,
                   ::std::string const &>("Test")
      .static_fun<&::test::fstatic>(
          "fstatic") // (bool, ::int32_t, double, ::std::shared_ptr<test>,
                     // ::std::shared_ptr<test>const &, ::std::string,
                     // ::std::string const &)
      .static_fun<&::test::bstatic>("bstatic") // bool
      .constructor<::int32_t>("TestSimple")
      .fun<&::test::fi>(
          "fi") // (bool, ::int32_t, double, ::std::shared_ptr<test>,
                // ::std::shared_ptr<test> const &, ::std::string, ::std::string
                // const &)
      .fun<&::test::fb>(
          "fb") // (bool, ::int32_t, double, ::std::shared_ptr<test>,
                // ::std::shared_ptr<test> const &, ::std::string, ::std::string
                // const &)
      .fun<&::test::fd>(
          "fd") // (bool, ::int32_t, double, ::std::shared_ptr<test>,
                // ::std::shared_ptr<test> const &, ::std::string, ::std::string
                // const &)
      .fun<&::test::fspt>(
          "fspt") // (bool, ::int32_t, double, ::std::shared_ptr<test>,
                  // ::std::shared_ptr<test> const&, ::std::string,
                  // ::std::string const &)
      .fun<&::test::fs>(
          "fs") // (bool, ::int32_t, double, ::std::shared_ptr<test>,
                // ::std::shared_ptr<test> const &, ::std::string, ::std::string
                // const &)
      .fun<&::test::f>("f") // (bool, ::int32_t, double,
                            // ::std::shared_ptr<test>, ::std::shared_ptr<test>
...
int main() {
  ...
  try {
    ...
    std::cerr << (exc.isError() ? "Error: " : "Throw: ") << (std::string)exc
              << std::endl;
    if ((bool)exc["stack"])
